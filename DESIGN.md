...
```css
/* Primary palette (pop) */
--tangerine:  #FF6339;   /* タンジェリン：メイン・CTA・マイク通常時 */
...
/* Neutral */
--text-primary:   #2D1F3D;   /* ディープパープル：本文 */
--text-secondary: #8B6B8B;   /* ミドルパープル：サブ */
--text-muted:     #C4A0C4;   /* ライトパープル：タイムスタンプ */
